package com.example.ass7dialogrv_sec2_603021234_4
...
class MainActivity : AppCompatActivity() {
    ...
    private fun  testEmployeeDate() {
        EmployeeList.add(Employee("mekko" ,"Male", "mekko@gmail.com" ,111111))
        EmployeeList.add(Employee("mek" ,"Male", "mekmek.k@kkumail.com" ,44444))
    }
}